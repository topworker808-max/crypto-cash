...
export function StickyActionBtn({ cityConfig, receiveAmount }: StickyActionBtnProps) {
    const handleOrderClick = () => {
        const link = cityConfig.affiliateLink || "https://qr.ex24.pro/pattayahelper";
        window.open(link, "_blank");
    };

    const displayAmount = receiveAmount ? receiveAmount.toLocaleString() : "CASH";
    ...
    return (
        <div className="fixed bottom-0 left-0 w-full z-50 p-4 bg-gradient-to-t from-background via-background/95 to-transparent pb-8">
            ...
            >
                ...
                >
                    <span className="mr-2">GET {displayAmount} {cityConfig.currency} NOW</span>
