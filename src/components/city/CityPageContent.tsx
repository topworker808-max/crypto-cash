        ...
        <main className="flex min-h-screen flex-col items-center justify-start pt-12 p-4 pb-40 bg-background text-foreground relative overflow-hidden">
            ...
            >
                ...
                <div className="pt-6 space-y-4 text-left">
                    <h3 className="text-lg font-semibold text-white text-center">{dict.benefits.title}</h3>
                    <div className="grid grid-cols-1 gap-3">
                        <div className="flex items-start gap-3 p-4 bg-[#242936] rounded-xl border border-white/5">
                            <TrendingUp className="w-5 h-5 text-green-500 mt-0.5" />
                            <div>
                                <h4 className="text-sm font-medium text-white">{dict.benefits.betterRate.title}</h4>
                                <p className="text-xs text-gray-400">{dict.benefits.betterRate.description}</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3 p-4 bg-[#242936] rounded-xl border border-white/5">
                            <Wallet className="w-5 h-5 text-blue-500 mt-0.5" />
                            <div>
                                <h4 className="text-sm font-medium text-white">{dict.benefits.noAtmFees.title}</h4>
                                <p className="text-xs text-gray-400">{dict.benefits.noAtmFees.description}</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3 p-4 bg-[#242936] rounded-xl border border-white/5">
                            <ShieldCheck className="w-5 h-5 text-purple-500 mt-0.5" />
                            <div>
                                <h4 className="text-sm font-medium text-white">{dict.benefits.safeDelivery.title}</h4>
                                <p className="text-xs text-gray-400">{dict.benefits.safeDelivery.description}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-8 space-y-6">
                    <h3 className="text-lg font-semibold text-white">{dict.howItWorks.title.replace('{city}', String(cityName))}</h3>
                    <div className="grid grid-cols-3 gap-4">
                        <div className="flex flex-col items-center gap-2 text-center">
                            <div className="w-12 h-12 rounded-2xl bg-[#242936] flex items-center justify-center text-white">
                                <CalcIcon className="w-6 h-6" />
                            </div>
                            <p className="text-xs text-gray-400">{dict.howItWorks.step1}</p>
                        </div>
                        <div className="flex flex-col items-center gap-2 text-center">
                            <div className="w-12 h-12 rounded-2xl bg-[#242936] flex items-center justify-center text-white">
                                <MessageCircle className="w-6 h-6" />
                            </div>
                            <p className="text-xs text-gray-400">{dict.howItWorks.step2}</p>
                        </div>
                        <div className="flex flex-col items-center gap-2 text-center">
                            <div className="w-12 h-12 rounded-2xl bg-[#242936] flex items-center justify-center text-white">
                                <Banknote className="w-6 h-6" />
                            </div>
                            <p className="text-xs text-gray-400">{dict.howItWorks.step3}</p>
                        </div>
                    </div>
                </div>
            </motion.div>
