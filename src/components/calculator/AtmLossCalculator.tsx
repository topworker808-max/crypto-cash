            ...
            <CardContent className="p-5 space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-red-600 font-medium">-{totalAtmFees.toLocaleString()} {cityConfig.currency}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-red-600 font-medium">-{conversionLoss.toLocaleString(undefined, { maximumFractionDigits: 0 })} {cityConfig.currency}</span>
                    </div>
                    ...
                    <div className="border-t border-gray-200 pt-3">
                        ...
                        <div className="flex items-center justify-between text-sm mb-2">
                            ...
                            <span className="text-red-600 font-bold">-{totalLoss.toLocaleString(undefined, { maximumFractionDigits: 0 })} {cityConfig.currency}</span>
                        </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-4">
                    <div className="flex items-center justify-between">
                        <span className="text-green-800 font-medium text-sm">{labels.savingsText}</span>
                        <span className="text-green-700 font-bold text-lg">+{savings.toLocaleString(undefined, { maximumFractionDigits: 0 })} {cityConfig.currency}</span>
                    </div>
                </div>
            </CardContent>
        </Card>
